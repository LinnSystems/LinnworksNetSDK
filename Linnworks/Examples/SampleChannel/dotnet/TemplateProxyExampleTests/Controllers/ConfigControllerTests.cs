...
using TemplateProxyExample.Controllers;
using TemplateProxyExample.Helpers;
using TemplateProxyExample.Models;
using TemplateProxyExample.Models.User;
using TemplateProxyExampleTests.Common;
using Xunit;

namespace TemplateProxyExampleTests.Controllers
{
    public class ConfigControllerTests
    {
        ...
        private ConfigController GetConfigControllerInstance()
        {
            ...
            return new ConfigController(config.Object);
        }
    }
}
