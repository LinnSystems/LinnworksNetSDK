...
namespace LinnworksAPI
{
    public static class ProcessedOrdersMethods
    {
        ...
        public static List<SearchField> GetSearchTypes(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<SearchField>>(Factory.GetResponse("ProcessedOrders/GetSearchTypes", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static ProcessedOrderColumnCollection GetColumns(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ProcessedOrderColumnCollection>(Factory.GetResponse("ProcessedOrders/GetColumns", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static ProcessedOrderColumnCollection SetColumnSortOrder(String sortColumn, Boolean sortAsc, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ProcessedOrderColumnCollection>(Factory.GetResponse("ProcessedOrders/SetColumnSortOrder", "sortColumn=" + sortColumn + "&sortAsc=" + sortAsc + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static ProcessedOrderColumnWithData SetColumns(List<String> columns, Boolean changeSortColumn, String sortColumn, Boolean sortAsc, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ProcessedOrderColumnWithData>(Factory.GetResponse("ProcessedOrders/SetColumns", "columns=" + Newtonsoft.Json.JsonConvert.SerializeObject(columns) + "&changeSortColumn=" + changeSortColumn + "&sortColumn=" + sortColumn + "&sortAsc=" + sortAsc + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static List<OrderItem> GetProcessedItemDetails(Guid pkOrderId, Boolean includeChildren, Boolean includeItemOptions, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<OrderItem>>(Factory.GetResponse("ProcessedOrders/GetProcessedItemDetails", "pkOrderId=" + pkOrderId + "&includeChildren=" + includeChildren + "&includeItemOptions=" + includeItemOptions + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
