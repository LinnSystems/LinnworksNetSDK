...
namespace LinnworksAPI
{
    public static class StockMethods
    {
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<VariationItem>>(Factory.GetResponse("Stock/AddVariationItems", "pkVariationItemId=" + pkVariationItemId + "&pkStockItemIds=" + Factory.SerializeAndUrlEscape(pkStockItemIds) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<VariationGroup>(Factory.GetResponse("Stock/CreateVariationGroup", "template=" + Factory.SerializeAndUrlEscape(template) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<StockConsumption>>(Factory.GetResponse("Stock/GetStockConsumption", "stockItemId=" + stockItemId + "&locationId=" + Factory.SerializeAndUrlEscape(locationId) + "&startDate=" + Factory.SerializeAndUrlEscape(startDate) + "&endDate=" + Factory.SerializeAndUrlEscape(endDate) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GenericPagedResult<StockItem>>(Factory.GetResponse("Stock/GetStockItems", "keyWord=" + keyWord + "&locationId=" + Factory.SerializeAndUrlEscape(locationId) + "&entriesPerPage=" + entriesPerPage + "&pageNumber=" + pageNumber + "&excludeComposites=" + excludeComposites + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static List<StockItem> GetStockItemsByKey(Search_Stock_ByKey stockIdentifier, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<StockItem>>(Factory.GetResponse("Stock/GetStockItemsByKey", "stockIdentifier=" + Factory.SerializeAndUrlEscape(stockIdentifier) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<StockItemFull>>(Factory.GetResponse("Stock/GetStockItemsFull", "keyword=" + keyword + "&loadCompositeParents=" + loadCompositeParents + "&loadVariationParents=" + loadVariationParents + "&entriesPerPage=" + entriesPerPage + "&pageNumber=" + pageNumber + "&dataRequirements=" + Factory.SerializeAndUrlEscape(dataRequirements) + "&searchTypes=" + Factory.SerializeAndUrlEscape(searchTypes) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<StockItemLevel>>(Factory.GetResponse("Stock/SetStockLevel", "stockLevels=" + Factory.SerializeAndUrlEscape(stockLevels) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<StockItemLevel>>(Factory.GetResponse("Stock/UpdateStockLevelsBySKU", "stockLevels=" + Factory.SerializeAndUrlEscape(stockLevels) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static void Update_StockItemPartial(PartialUpdateParameter update, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Stock/Update_StockItemPartial", "update=" + Factory.SerializeAndUrlEscape(update) + "", ApiToken, ApiServer);
        }

        public static void BookInStockItem(BookInStockItem stockItem, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Stock/BookInStockItem", "stockItem=" + Factory.SerializeAndUrlEscape(stockItem) + "", ApiToken, ApiServer);
        }
    }
}