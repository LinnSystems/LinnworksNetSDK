...
namespace LinnworksAPI
{
    public static class StockMethods
    {
        ...
        public static List<VariationParentSKUSearchItem> FindInstantNewParentSKU(String keyWord, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<VariationParentSKUSearchItem>>(Factory.GetResponse("Stock/FindInstantNewParentSKU", "keyWord=" + keyWord + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static GenericPagedResult<VariationParentSKUSearchItem> GetNewParentSKUs(String keyWord, Int32 entriesPerPage, Int32 pageNumber, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GenericPagedResult<VariationParentSKUSearchItem>>(Factory.GetResponse("Stock/GetNewParentSKUs", "keyWord=" + keyWord + "&entriesPerPage=" + entriesPerPage + "&pageNumber=" + pageNumber + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static WeightMeasure GetSystemWeightMeasure(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<WeightMeasure>(Factory.GetResponse("Stock/GetSystemWeightMeasure", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static List<WeightMeasure> GetWeightMeasures(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<WeightMeasure>>(Factory.GetResponse("Stock/GetWeightMeasures", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static String GetNewSKU(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<String>(Factory.GetResponse("Stock/GetNewSKU", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static List<StockItem> FindInstantStockItems(String keyWord, Guid locationId, Boolean excludeComposites, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<StockItem>>(Factory.GetResponse("Stock/FindInstantStockItems", "keyWord=" + keyWord + "&locationId=" + locationId + "&excludeComposites=" + excludeComposites + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
