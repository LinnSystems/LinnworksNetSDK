...
namespace LinnworksAPI
{
    public static class OrdersMethods
    {
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<MoveToLocationResult>(Factory.GetResponse("Orders/MoveToLocation", "orderIds=" + Newtonsoft.Json.JsonConvert.SerializeObject(orderIds) + "&pkStockLocationId=" + pkStockLocationId + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<Guid>>(Factory.GetResponse("Orders/ClearPickListPrinted", "orderIds=" + Newtonsoft.Json.JsonConvert.SerializeObject(orderIds) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<OpenOrder>>(Factory.GetResponse("Orders/GetOrders", "ordersIds=" + Newtonsoft.Json.JsonConvert.SerializeObject(ordersIds) + "&fulfilmentLocationId=" + Newtonsoft.Json.JsonConvert.SerializeObject(fulfilmentLocationId) + "&loadItems=" + loadItems + "&loadAdditionalInfo=" + loadAdditionalInfo + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UpdateOrderItemResult>(Factory.GetResponse("Orders/AddOrderItem", "orderId=" + orderId + "&itemId=" + itemId + "&channelSKU=" + channelSKU + "&fulfilmentCenter=" + fulfilmentCenter + "&quantity=" + quantity + "&linePricing=" + Newtonsoft.Json.JsonConvert.SerializeObject(linePricing) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        {
            Factory.GetResponse("Orders/SetOrderCustomerInfo", "orderId=" + orderId + "&info=" + Newtonsoft.Json.JsonConvert.SerializeObject(info) + "&saveToCrm=" + Newtonsoft.Json.JsonConvert.SerializeObject(saveToCrm) + "", ApiToken, ApiServer);
        }
