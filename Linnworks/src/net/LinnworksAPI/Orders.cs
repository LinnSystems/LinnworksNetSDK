...
namespace LinnworksAPI
{
    public static class OrdersMethods
    {
        ...
        public static UserOrderView CreateOrderView(String ViewName, String OrderViewDetailJSON, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UserOrderView>(Factory.GetResponse("Orders/CreateOrderView", "ViewName=" + ViewName + "&OrderViewDetailJSON=" + OrderViewDetailJSON + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static void DeleteOrderView(Int32 pkViewId, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Orders/DeleteOrderView", "pkViewId=" + pkViewId + "", ApiToken, ApiServer);
        }

        public static Int32 GetLatestOrderViewId(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Int32>(Factory.GetResponse("Orders/GetLatestOrderViewId", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static void SetOrderViewsOrder(Int32 viewsOrder, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Orders/SetOrderViewsOrder", "viewsOrder=" + Newtonsoft.Json.JsonConvert.SerializeObject(viewsOrder) + "", ApiToken, ApiServer);
        }

        public static OrdersAppSettings GetUserAppSettings(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OrdersAppSettings>(Factory.GetResponse("Orders/GetUserAppSettings", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static void SetUserAppSettings(OrdersAppSettings settings, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Orders/SetUserAppSettings", "settings=" + Newtonsoft.Json.JsonConvert.SerializeObject(settings) + "", ApiToken, ApiServer);
        }
        ...
        public static BasicStockItem TryAutoMatchItem(String itemTitle, String channelSKU, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<BasicStockItem>(Factory.GetResponse("Orders/TryAutoMatchItem", "itemTitle=" + itemTitle + "&channelSKU=" + channelSKU + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static PrintStockLabelConfiguration GetPrintStockLabelConfig(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<PrintStockLabelConfiguration>(Factory.GetResponse("Orders/GetPrintStockLabelConfig", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static KeyValuePair<ExportResult, String> ExportOrders(String group, List<Guid> orders, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<KeyValuePair<ExportResult, String>>(Factory.GetResponse("Orders/ExportOrders", "group=" + group + "&orders=" + Newtonsoft.Json.JsonConvert.SerializeObject(orders) + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static List<FieldVisibility> GetFieldsVisibility(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<FieldVisibility>>(Factory.GetResponse("Orders/GetFieldsVisibility", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static void SetFieldsVisibility(List<FieldVisibility> visibility, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Orders/SetFieldsVisibility", "visibility=" + Newtonsoft.Json.JsonConvert.SerializeObject(visibility) + "", ApiToken, ApiServer);
        }

        public static List<FieldVisibility> GetDefaultFieldsVisibility(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<FieldVisibility>>(Factory.GetResponse("Orders/GetDefaultFieldsVisibility", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static String GetDatabaseHashString(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<String>(Factory.GetResponse("Orders/GetDatabaseHashString", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static Dictionary<String, String> GetAddressFormats(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<String, String>>(Factory.GetResponse("Orders/GetAddressFormats", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
