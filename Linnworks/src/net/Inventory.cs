...
namespace LinnworksAPI
{
    public static class InventoryMethods
    {
        ...
        public static List<String> GetSystemPropertyNames(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<String>>(Factory.GetResponse("Inventory/GetSystemPropertyNames", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static void UpdateInventoryItemField(Guid inventoryItemId, ColumnNameType fieldName, String fieldValue, String ApiToken, String ApiServer)
        {
        ...
        public static void UpdateInventoryItemStockField(Guid inventoryItemId, ColumnNameType fieldName, String fieldValue, Guid locationId, String ApiToken, String ApiServer)
        {
        ...
        public static void UpdateInventoryItemLocationField(Guid inventoryItemId, ColumnNameType fieldName, String fieldValue, Guid locationId, String ApiToken, String ApiServer)
        {
        ...
        public static List<Filter> GetInventoryFilterTypes(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<Filter>>(Factory.GetResponse("Inventory/GetInventoryFilterTypes", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static List<Column> GetInventoryColumnTypes(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<Column>>(Factory.GetResponse("Inventory/GetInventoryColumnTypes", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }

        public static InventoryView GetNewInventoryView(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<InventoryView>(Factory.GetResponse("Inventory/GetNewInventoryView", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static void DuplicateInventoryItem(StockItem inventoryItem, Guid sourceItemId, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Inventory/DuplicateInventoryItem", "inventoryItem=" + Newtonsoft.Json.JsonConvert.SerializeObject(inventoryItem) + "&sourceItemId=" + sourceItemId + "", ApiToken, ApiServer);
        }
        ...
        public static Dictionary<Guid, List<PictureSource>> GetInventoryItemImagesForTemplates(List<Guid> inventoryItemIds, String source, String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<Guid, List<PictureSource>>>(Factory.GetResponse("Inventory/GetInventoryItemImagesForTemplates", "inventoryItemIds=" + Newtonsoft.Json.JsonConvert.SerializeObject(inventoryItemIds) + "&source=" + source + "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
        ...
        public static void DeleteImagesFromInventoryItem(String imageURL, Guid inventoryItemId, String ApiToken, String ApiServer)
        {
        ...
        public static void DeleteCountries(IEnumerable<Guid> countries, String ApiToken, String ApiServer)
        {
            Factory.GetResponse("Inventory/DeleteCountries", "countries=" + Newtonsoft.Json.JsonConvert.SerializeObject(countries) + "", ApiToken, ApiServer);
        }
        ...
        public static List<Supplier> GetSupplierList(String ApiToken, String ApiServer)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<List<Supplier>>(Factory.GetResponse("Inventory/GetSupplierList", "", ApiToken, ApiServer), new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
        }
