...
namespace LinnworksAPI
{
    public class OrderWorkflowController : BaseController, IOrderWorkflowController
    {
		...
		{
			var response = GetResponse("OrderWorkflow/DeallocateOrderFromJob", "request=" + JsonFormatter.ConvertToJson(request) + "");
		...
		{
			var response = GetResponse("OrderWorkflow/GetGroup", "request=" + JsonFormatter.ConvertToJson(request) + "");
		...
		{
			var response = GetResponse("OrderWorkflow/GetJob", "request=" + JsonFormatter.ConvertToJson(request) + "");
		...
		{
			var response = GetResponse("OrderWorkflow/GetJobAudit", "request=" + JsonFormatter.ConvertToJson(request) + "");
		...
		{
			var response = GetResponse("OrderWorkflow/GetJobByName", "request=" + JsonFormatter.ConvertToJson(request) + "");
            return JsonFormatter.ConvertFromJson<GetJobResponse>(response);
		}
		...
		{
			var response = GetResponse("OrderWorkflow/GetJobErrors", "request=" + JsonFormatter.ConvertToJson(request) + "");
		...
		{
			var response = GetResponse("OrderWorkflow/Run", "request=" + JsonFormatter.ConvertToJson(request) + "");
		...
		{
			var response = GetResponse("OrderWorkflow/UpdateGroup", "request=" + JsonFormatter.ConvertToJson(request) + "");
