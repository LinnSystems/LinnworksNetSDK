...
{ 
    public interface IPurchaseOrderController
	{
		...
		CommonPurchaseOrderHeader Change_PurchaseOrderStatus(Change_PurchaseOrderStatusParameter changeStatusParameter);
		...
		CommonPurchaseOrderHeader Delete_PurchaseOrderItem(Delete_PurchaseOrderItemParameter deleteItemParameter);
		Int32 Delete_PurchaseOrderNote(Guid pkPurchaseId,Guid pkPurchaseOrderNoteId);
		DeliverPurchaseOrderItemResponse Deliver_PurchaseItem(DeliverPurchaseOrderItemRequest deliverItemParameter);
		...
		void Deliver_PurchaseItems_WithQuantity(DeliverAllPurchaseOrderItemsRequest request);
		...
		PurchaseOrderResponse Get_PurchaseOrder(Guid pkPurchaseId);
		...
		PurchaseOrderModify_AdditionalCostResponse Modify_AdditionalCost(Modify_AdditionalCostRequest request);
		Modify_AdditionalCostAllocationResponse Modify_AdditionalCostAllocation(Modify_AdditionalCostAllocationRequest request);
		PurchaseOrderModify_PaymentStatementResponse Modify_PaymentStatement(Modify_PaymentStatementRequest request);
		...
		CommonPurchaseOrderHeader Update_PurchaseOrderHeader(Update_PurchaseOrderHeaderParameter updateParameter);
