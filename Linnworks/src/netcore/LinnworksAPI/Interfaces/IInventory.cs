...
{ 
    public interface IInventoryController
	{
		...
		LinnworksCategory CreateCategory(String categoryName,Guid? categoryId = null);
		...
		BatchedAPIResponse<DeleteInventoryItemBulkResponse> DeleteInventoryItemBulk(DeleteInventoryItemBulkRequest request);
		...
		void DeleteInventoryItemExtendedProperties(Guid? inventoryItemId,List<Guid> inventoryItemExtendedPropertyIds,String itemNumber = "");
		BatchedAPIResponse<DeleteInventoryItemImagesResponse> DeleteInventoryItemImageBulk(List<DeleteInventoryItemImagesRequest> request);
		...
		List<StockItemExtendedProperty> GetInventoryItemExtendedProperties(Guid? inventoryItemId,GetExtendedPropertyFilter propertyParams,String itemNumber = "");
		List<StockItemImage> GetInventoryItemImages(GetInventoryItemImagesRequest request);
		...
		GetProductIdentifierExtendedResponse GetProductIdentifierExtendedTypes();
		...
		GetScannableProductIdentifiersByOrderIdsResponse GetScannableProductIdentifiersByOrderIds(GetScannableProductIdentifiersByOrderIdsRequest request);
		...
		List<StockItemSupplierStat> GetStockSupplierStatsBulk(List<Guid> inventoryItemIds);
		...
		UpdateBatchDatesResponse UpdateBatchDates(UpdateBatchDatesRequest request);
		...
		void UpdateInventoryItem(UpdateInventoryItemRequest inventoryItem);
		...
		void UpdateInventoryItemExtendedProperties(List<StockItemExtendedPropertyWithSku> inventoryItemExtendedProperties);
